...
__DEFINE__(1679363360383, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1679363360384,"./event-store":1679363360385}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679363360384, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1679363360385, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1679363360384,"./utils":1679363360386}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679363360386, function(require, module, exports) {
...
return __REQUIRE__(1679363360383);
})()
